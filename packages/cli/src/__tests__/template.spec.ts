...
describe('template', () => {
  ...
  describe('#createTemplate', () => {
    it('should create react component code snippet', () => {
      ...
      expect(infoStub).toBeCalledWith(expect.stringMatching('create components/primary-button/index.tsx'));
      expect(infoStub).toBeCalledWith(expect.stringMatching('create components/primary-button/demo.md'));
      expect(infoStub).toBeCalledWith(expect.stringMatching('create components/primary-button/primary button.tsx'));
      expect(infoStub).toBeCalledWith(expect.stringMatching('create components/primary-button/style/index.tsx'));
      expect(infoStub).toBeCalledWith(expect.stringMatching('create components/primary-button/style/index.scss'));
